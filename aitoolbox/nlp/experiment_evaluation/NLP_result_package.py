...
from aitoolbox.nlp.experiment_evaluation.NLP_metrics import ROUGEMetric, ROUGEPerlMetric, ExactMatchMetric, \
...
class QuestionAnswerResultPackage(AbstractResultPackage):
    ...
    def prepare_results_dict(self):
        ...
        em_metric = ExactMatchMetric(true_text, pred_text, target_actual_text=self.use_target_actual_text)
