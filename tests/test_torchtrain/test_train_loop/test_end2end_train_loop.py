...
class TestEnd2EndTrainLoop(unittest.TestCase):
    def test_e2e_ff_net_train_loop(self):
        ...
        linux_result = {
            'loss': [2.224587655067444, 2.1440203189849854, 2.0584306001663206, 1.962017869949341, 1.8507084846496582],
            'accumulated_loss': [2.3059947967529295, 2.1976317405700683, 2.114974856376648, 2.0259472012519835, 1.9252637863159179],
            'val_loss': [2.330514828364054, 2.345397472381592, 2.363233804702759, 2.3853348096211753, 2.4111196994781494],
            'train_end_test_loss': [2.31626296043396]
        }
